...
const RASE_SERVICE_REQUEST = {
  ...
  stateVariables: [
    { name: "scheduleReady", initialValue: "0" },
  ],
  bEvents: [
    ...
    { id: "b_schedule_ready", name: "Schedule Slot Ready", scheduledTime: "120", effect: ["SET(scheduleReady, 1)"],
      schedules: [{ eventId: "b_schedule_ready", dist: "Fixed", distParams: { value: "120" } }] },
    { id: "b_schedule_done", name: "Schedule Done", scheduledTime: "9999", effect: [],
      probabilisticRouting: [{ probability: 1.0, queueName: "ExecutionQueue" }] },
  ...
  cEvents: [
    ...
    { id: "c_schedule", name: "Schedule into Slot", priority: 2,
      condition: "queue(ScheduleQueue).length >= 1 AND isWeekday AND hourOfDay >= 9 AND hourOfDay < 17 AND scheduleReady == 1",
      effect: ["DELAY(ScheduleQueue, 5)", "SET(scheduleReady, 0)"],
