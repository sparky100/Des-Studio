...
function buildRunProvenance(runMeta) {
  ...
  <section>
    ...
    <p class="note">This report was generated from a run record stored in DES Studio. The model definition, experiment configuration, and results are preserved in the run record and can be reproduced exactly using the Reproduce Run function.</p>
  </section>`;
}
