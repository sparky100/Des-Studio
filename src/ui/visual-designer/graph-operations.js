...
// Pure layout helpers for the selection actions bar. Both return an array of
// `{ id, x, y }` position patches consumed by updateGraphLayout/moveNodes.
// Align requires 2+ nodes, distribute 3+ — fewer returns [] so callers can
// gate the buttons on selection count and pass the result through untouched.
