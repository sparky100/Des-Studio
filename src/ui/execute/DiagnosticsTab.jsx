...
const DIAGNOSIS_SYSTEM_PROMPT = `You are an expert discrete event simulation debugger. You are analysing a flow model and its simulation run output to identify why the model is not behaving as expected.

flow uses a three-event paradigm:
...
function buildChatSystemPrompt(modelJson, traceJson, statsJson) {
  return `You are an expert flow simulation debugger in a conversation with the model author.
