              ...
              <div aria-label="Queue depth chart grid" style={CHART_GRID}>
                {queueSection.series.map((series, idx) => {
                  ...
                  return (
                    ...
                    >
                      <MiniLineChart title={title} points={series.points} color={color} yLabel="depth" />
                    </ChartCard>
                  );
                })}
              </div>
                ...
                {serverSection.series.map((series, idx) => {
                  ...
                  return (
                    <ChartCard
                      ...
                      dataPreview={<SeriesDataPreview series={series} />}
                    >
                      <MiniLineChart title={series.label} points={series.points} color={color} yLabel="% busy" formatY={fmtPct} />
                    </ChartCard>
                  );
                })}
              </div>
